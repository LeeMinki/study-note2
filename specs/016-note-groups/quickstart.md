...
### S5-1. 새 노트 작성 패널 접기/펼치기

1. 기본 또는 좁게 레이아웃에서 `새 노트` 패널의 접기 버튼을 누른다.
2. 노트 목록이 왼쪽으로 확장되는지 확인한다.
3. 상단 `새 노트` 버튼을 눌러 작성 패널을 다시 연다.

Expected:

- 접힌 상태에서 작성 패널의 잔여 UI가 노트 목록을 침범하지 않는다.
- 다시 열면 기존 작성 UI를 사용할 수 있다.
