...
- [x] T065 Configure k3s CoreDNS upstream to public resolvers for Argo CD GitHub and Let’s Encrypt DNS resolution in `infra/terraform/scripts/ec2-bootstrap.sh`
