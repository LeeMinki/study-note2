...
- 인증: JWT 기반 로그인/회원가입, Google SSO 로그인, 계정별 노트 분리, 프로필 조회/수정, 비밀번호 변경
...
18. CSS 변수 기반 디자인 토큰, 전 UI 한국어화
19. TipTap WYSIWYG 에디터 ("텍스트 편집기" / "마크다운" 이중 모드)
20. 노트 전체화면 보기, JWT sessionStorage 전환
